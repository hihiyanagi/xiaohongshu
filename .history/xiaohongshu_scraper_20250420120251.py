...
def main():
    ...
    # 抓取内容
    result = scrape_xiaohongshu('https://www.xiaohongshu.com/explore/6618f1d0000000000401a5d5?xsec_token=ABkGk3c2NypnczopOl1AlhBgJDUZO1jL3zsAWZqWs-LK0=&xsec_source=pc_user')
