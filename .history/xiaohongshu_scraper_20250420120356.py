...
def main():
    ...
    # 抓取内容
    result = scrape_xiaohongshu('https://www.xiaohongshu.com/explore/648ae26f0000000013003807?xsec_token=ABALbUeAze8d53IC0SZ61dSi2By-yI0SdonaXLIIR5gU8=&xsec_source=pc_user')
